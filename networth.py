# Program to display past and current net worth.
# Author: Ric Werme, Oct 2005
# Run with: moneydance -invoke_and_quit moneydance:fmodule:jpython:runfile?=networth.py

# Configuration variables, ** set these before you run this program. **

# Datestr is a list of dates of when you want the net worth computed.
# Edit it to fit your needs.  The dates must be sorted from earliest
# to latest.
datestr = ['2011-1-1', '2011-4-1', '2011-7-1', '2011-10-1', '2011-11-1']

# This program doesn't have ready access to displaying data on screen, so
# we create text and HTML files.
textfile = 'networth.txt'
htmlfile = 'networth.html'
